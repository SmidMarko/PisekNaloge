	...
	var localLanguageStrings = {
		sl: {
			...
			label: {									//Imena ukazov
				...
				markedCell: "je na polju korenček",
			...
			messages: {								//Besedila sporočil
				...
				successMarkersPainted: "Čestitamo, zajček je pravilno pobral korenčke!",
				failureMarkersPainted: "Zajček ni pravilno pobral korenčkov.",
				...
				leavesGrid: "Zajček je zapustil mrežo!",
