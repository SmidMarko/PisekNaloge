   ...
   var localLanguageStrings = {
      ...
      sl: {
         label: {
            ...
            left: "obrni se levo",
            forward: "poleti naprej",
            turnAround: "obrni se okoli",
            jump: "skoči",
            down: "pojdi dol",
            east: "premakni se levo",
            south: "premakni se dol",
            west: "premakni se desno",
            north: "premakni se gor",
            paint: "postavi gnezdo",
            pickTransportable: "poberi zrno",
            dropTransportable: "pospravi zrno",
            onTransportable: "na zrnu",
         ...
         messages: {
            ...
            alreadyTransporting: "Gasilka že nosi predmet.",
            notTransporting: "Gasilka skuša spustiti predmet, vendar ga ne nosi.",
            successDroppedAllObjects: "Čestitamo, spustil(-a) si vse predmete!",
            successMarkersPainted: "Čestitamo, Gasilka je pravilno postavil gnezda!",
            failureMarkersPainted: "Gasilka ni postavil gnezda na pravo polje.",
            successPickedAllCollectibles: "Čestitamo, Rozi je oprašila vse rože",
            failurePickedAllCollectibles: "Ojoj, Rozi ni oprašila vseh rož. Poskusi še enkrat",
            successReachGeenArea: "Super! Gasilka se je prišel do kraja požarja.",
            failureReachGeenArea: "Ojoj! Gasilka ni prispel do požarja. Poskusi še enkart.",
            successOneMarbleInHole: "Čestitamo, zrno je v gnezdu!",
            successAllMarblesInHoles: "Čestitamo, vsa zrna so v gnezdu!",
            failureOneMarbleInHole: "Zrno ni v gnezdu!",
            failureAllMarblesInHoles: "Vsa zrna niso v gnezdu!",
            leavesGrid: "Ojoj, Rozi se je zaletela v drevo. Poskusi še enkrat."
         },
         description: {
            platformAbove: "ploščadZgoraj(): Ali obstaja ploščad nad Piščkom?",
            obstacleInFront: "oviraSpredaj(): Ali obstaja ovira pred Piščkom?",
            onHole: "naLuknji(): Ali je Pišček na gnezdu?",
            onTransportable: "naPredmetu(): Ali je Pišček na predmetu, ki ga lahko pobere?",
            onRoundObject: "naKrogu(): Ali je Pišček na okroglem predmetu?",
            onSquareObject: "naKvadratu(): Ali je Pišček na kvadratnem predmetu?",
            onTriangleObject: "naTrikotniku(): Ali je Pišček na trikotnem predmetu?",
            onDottedObject: "naPikčastemPredmetu(): Ali je Pišček na pikčastem predmetu?",
            onFullObject: "naPolnemPredmetu(): Ali je Pišček na polnem predmetu?",
            onStripedObject: "naČrtastemPredmetu(): Ali je Pišček na črtastem predmetu?",
            paintOnCell: "pobarvanoPolje(): Ali je polje, na katerem je Pišček, pobarvano?",
            gridEdgeInFront: "robMrežeSpredaj(): Ali je rob mreže pred Piščkom?",
            gridEdgeEast: "robMrežeDesno(): Ali je rob mreže desno od Piščka?",
            gridEdgeWest: "robMrežeLevo(): Ali je rob mreže levo od Piščka?",
            gridEdgeAbove: "robMrežeZgoraj(): Ali je rob mreže nad Piščkom?",
            gridEdgeBelow: "robMrežeSpodaj(): Ali je rob mreže pod Piščkom?",
            platformInFront: "ploščadSpredaj(): Ali obstaja ploščad pred Piščkom?",
            numberUnder: "številkaPolja(): Številka polja, na katerem je Pišček.",
            col: "stolpec(): Stolpec na katerem je Pišček",
            row: "vrstica(): Vrstica na kateri je Pišček",
            paintNorth: "pobarvanaZgoraj(): Ali je pobarvano polje nad poljem, na katerem je Pišček?",
            paintNorthEast: "pobarvanaZgorajDesno(): Ali je pobarvano polje desno nad poljem, na katerem je Pišček?",
            writeNumber: "zaPiščiŠtevilko(številka): ZaPišče številko v polje, na katerem je Pišček."
         },
         obstacle: "Ojoj, Rozi se je zaletela v drevo. Poskusi še enkrat.",
         startingBlockName: "Program",
         exit_grid: "Rozi je zapustila mrežo!",
         nothingToPickUp: "Ni predmetov, ki bi jih lahko pobral.",
         alreadyTransportingObject: "Gasilka že nosi predmet.",
         jumpOutsideGrid: "Gasilka skuša skočiti izven mreže!",
         jumpObstacleBlocking: "Gasilka skuša skočiti, vendar zaradi ovire ne more!",
         jumpNoPlatform: "Gasilka skuša skočiti, vendar ni nobene ploščadi!",
         downOutsideGrid: "Gasilka se skuša premakniti izven mreže!",
         downNoPlatform: "Gasilka se skuša premakniti dol, vendar spodaj ni ploščadi!",
         falls: "Gasilka pada v prazno.",
         willFallAndCrash: "Gasilka bo padel z ploščadi in se poškodoval!",
         dropWithoutItem: "Gasilka skuša spustiti predmet, vendar ga ne nosi.",
